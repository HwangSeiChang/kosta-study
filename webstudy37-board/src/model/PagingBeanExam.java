...
public class PagingBeanExam {
	...
	public PagingBeanExam() {
	}

	public PagingBeanExam(int totalContents) {
		this.totalContents = totalContents;
	}

	public PagingBeanExam(int totalContents, int nowPage) {
		this.totalContents = totalContents;
	...
	public static void main(String args[]) {
		PagingBeanExam p = new PagingBeanExam(47, 10);
...
//		System.out.println("getTotalPageGroup:" + p.getTotalPageGroup());
		System.out.println("////////////////////////////");
//		p = new PagingBeanExam(31, 6);// 게시물수 31 현재 페이지 6
